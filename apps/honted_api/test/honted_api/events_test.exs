defmodule HonteDAPI.EventsTest do
  @moduledoc """
  Tests how one can use the API to subscribe to topics and receive event notifications
  
  Uses the application's instance of HonteDEvents.Eventer
  
  Uses the public HonteDAPI for subscription/unsubscription and the public HonteDEvents api to emit events
  """
