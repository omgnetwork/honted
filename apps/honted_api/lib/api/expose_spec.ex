defmodule HonteD.API.ExposeSpec do
  @moduledoc """
  `use HonteD.API.ExposeSpec` to expose all @spec in the runtime via YourModule.get_specs()
  ...
  defp function_arg({argtype, _, nil}) do
    argtype
  end
  ...
  defmacro __using__(_opts) do
    quote do
      import HonteD.API.ExposeSpec

      @before_compile HonteD.API.ExposeSpec
    end
  end
